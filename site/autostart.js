/* Module loading errors must be visible, not an endless loading label. */
(()=>{
 ...
 import('./app.js?v=3.0.4').then(()=>{ready=true;clearTimeout(timer);}).catch(error=>{clearTimeout(timer);fail(error);});
})();
