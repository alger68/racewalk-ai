import { bboxFromLandmarks, estimateGroundY, flightIntervals, supportKnee, computeFrameMetrics, runMonkeyCore, DETECTION_BANDS, DETECTION_SOURCE, contactBandUsed, diagnoseCapture, affectedMetrics, snapFps, medianFps, gaitMetrics } from './core.js?v=3.0.4';
...
function renderDiagnosis(){
 ...
 const findings=state.report?diagnoseCapture(state.report):[];
